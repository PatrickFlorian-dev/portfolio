...
export class PortfolioComponent implements OnInit {
    ...
    images: PortfolioImgsInfo[] = [
        ...
        { portfolioID: 4 , imgSrc: 'assets/img/bgs/admin-bg-1-min.jpg' , modalImgOneLink: 'assets/img/bgs/admin-bg-2-min.jpg' , modalImgTwoLink: 'assets/img/bgs/admin-bg-3-min.jpg', imgTitle: 'My Admin Site' , imgCategoryName: 'Freelance', imgCategory: 3, link: '/admin-demo' , externalLink: false, show: true , imgDescription: `This is one of the admin templates I quickly whipped up recently for a client. Of course the real thing is way more extensive but this is just an example of how I can rapidly whip up a website.` },
