...
export class PortfolioComponent implements OnInit {
    ...
    images: PortfolioImgsInfo[] = [
        ...
        { portfolioID: 2 , imgSrc: 'assets/img/bgs/blog-bg-1.png' , modalImgOneLink: 'assets/img/bgs/blog-bg-2.png' , modalImgTwoLink: 'assets/img/bgs/blog-bg-3.png', imgTitle: 'PBJ' , imgCategoryName: 'Freelance', imgCategory: 3, link: '/portfolio-blog' , externalLink: false, show: true , imgDescription: `In my free time I love writing articles and how-to's, so I created PBJ! Patrick's Blogs & Jams. A site where you can read up on some cool blogs and check out some new music.` },
        ...
        { portfolioID: 4 , imgSrc: 'assets/img/placeholder3.jpg' , modalImgOneLink: 'assets/img/placeholder1.jpg' , modalImgTwoLink: 'assets/img/placeholder1.jpg', imgTitle: 'Title' , imgCategoryName: 'N/A', imgCategory: 5, link: '#' , externalLink: true, show: true , imgDescription: 'This is the body of the modal dynamically loaded!' },
        { portfolioID: 5 , imgSrc: 'assets/img/placeholder4.jpg' , modalImgOneLink: 'assets/img/placeholder2.jpg' , modalImgTwoLink: 'assets/img/placeholder2.jpg', imgTitle: 'Title' , imgCategoryName: 'N/A', imgCategory: 6, link: '#' , externalLink: true, show: true , imgDescription: 'This is the body of the modal dynamically loaded!' },
