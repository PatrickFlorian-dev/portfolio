...
export class PortfolioComponent implements OnInit {
    ...
    images = [
        ...
        { portfolioID: 5 , imgSrc: 'assets/img/bgs/mountains-bg-1.png' , modalImgOneLink: 'assets/img/bgs/mountains-bg-2.png' , modalImgTwoLink: 'assets/img/bgs/mountains-bg-3.png', imgTitle: 'Theme Forest Project' , imgCategoryName: 'Career', imgCategory: 4, link: '/explore-more' , externalLink: true, show: true , imgDescription: 'An innovative theme I built to distribute on Theme Forest to show off my design skills. This is the basic version I use just to showcase here, there is the more advanced template on Theme Forest I used a while back.' },
        { portfolioID: 6 , imgSrc: 'assets/img/bgs/amro2.png' , modalImgOneLink: 'assets/img/bgs/amro1.png' , modalImgTwoLink: 'assets/img/bgs/amro3.png', imgTitle: 'ABN AMRO Bank' , imgCategoryName: 'IOS/Android Contract', imgCategory: 5, link: 'https://apps.apple.com/gw/app/mobiel-bankieren/id439728011' , externalLink: true, show: true , imgDescription: 'ABN AMRO, was a big project of mine back in 2020. They are a Dutch (Amsterdam) based banking for the EU and other countries. During the pandemic they hired me on as a contractor to assist in the work load for revamping their mobile apps on both IOS and Android.' },
        { portfolioID: 7 , imgSrc: 'assets/img/bgs/24intouch1.png' , modalImgOneLink: 'assets/img/bgs/24intouch2.png' , modalImgTwoLink: 'assets/img/bgs/24intouch3.png', imgTitle: '24-7 InTouch' , imgCategoryName: 'Career', imgCategory: 2, link: 'https://24-7intouch.com/' , externalLink: true, show: true , imgDescription: '24-7 Intouch was one of my first web development gigs! Compromising of both maintaining the front-end site and the backend software employees used for our call center and logistics operations.' },
    ];
